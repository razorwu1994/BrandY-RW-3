...
filePath = ["\map1\map1-0.txt","\map1\map1-1.txt","\map1\map1-2.txt","\map1\map1-3.txt","\map1\map1-4.txt","\map2\map2-0.txt","\map2\map2-1.txt"
			...
			,"\map5\map5-1.txt","\map5\map5-2.txt","\map5\map5-3.txt","\map5\map5-4.txt","\map1\map1-5.txt","\map1\map1-6.txt","\map1\map1-7.txt","\map1\map1-8.txt","\map1\map1-9.txt","\map2\map2-5.txt","\map2\map2-6.txt"
