...
As expected, heuristic 1 (diagonal distance) and heuristic 3 (Euclidean distance) performed the best in terms of path length out of all of the heuristics. Heuristic 1 (H1) also performed better than H3 in terms of nodes expanded and slightly better in terms of time. 
